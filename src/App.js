  ...
  return (
    <Container maxWidth={"lg"} sx={{ height: "100vh", py: 2 }}>
      <Grid container>
        ...
        <Grid item xs={12}>
          <Typography variant={"h6"} sx={{ fontWeight: "bold", mb: 4, mt: 4 }}>
            #Usage
          </Typography>
          <p>
            There are a lot of type combination for using the modules. I shared
            some examples for using below.
          </p>

          <p>
            - You have to know some things firstly.
            <strong>The module not allowed left twice space characters.</strong>
          </p>
          <p>
